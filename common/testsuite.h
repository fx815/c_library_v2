...
static void mavlink_test_optical_flow_tau_theta(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_OPTICAL_FLOW_TAU_THETA >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_optical_flow_tau_theta_t packet1, packet2;
        ...
        packet1.left_force = packet_in.left_force;
        packet1.right_force = packet_in.right_force;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_OPTICAL_FLOW_TAU_THETA_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_OPTICAL_FLOW_TAU_THETA_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_optical_flow_tau_theta_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_optical_flow_tau_theta_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_optical_flow_tau_theta_pack(system_id, component_id, &msg , packet1.tau , packet1.theta , packet1.left_force , packet1.right_force );
    mavlink_msg_optical_flow_tau_theta_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_optical_flow_tau_theta_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.tau , packet1.theta , packet1.left_force , packet1.right_force );
    mavlink_msg_optical_flow_tau_theta_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_optical_flow_tau_theta_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_optical_flow_tau_theta_send(MAVLINK_COMM_1 , packet1.tau , packet1.theta , packet1.left_force , packet1.right_force );
    mavlink_msg_optical_flow_tau_theta_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_optical_flow_tau_theta(system_id, component_id, last_msg);
